...
public class StrategieHard extends StrategieIntelligent {
    ...
    /**
     * Operation qui permet d'affecter un ouvrier à un batiment pour Strategie Hard
     *
    ...
    /**
     * Operation qui permet d'affecter un ouvrier à un batiment pour Strategie Hard Antiquite
     *
     * @param carteBatiment, Carte Batiment
